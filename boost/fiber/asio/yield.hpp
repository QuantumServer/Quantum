                ...
                class yield_handler_base {
                    public:
                        ...
                        void operator()(boost::system::error_code const &ec) {
                            ...
                            yield_completion::lock_t lk {
                                ycomp_->mtx_
                            };
                            // Notify a subsequent yield_completion::wait() call that it need not suspend.
                            ...
                            *yt_.ec_ = ec;
                            ...
                            // async function called async_result_base::get(), we must not set it ready.
                        ...
                        yield_t yt_;
                        // We depend on this pointer to yield_completion, which will be injected by async_result.
                ...
                class yield_handler : public yield_handler_base {
                    public:
                        ...
                        void operator()(boost::system::error_code const &ec, T t) {
                            ...
                            // move the value to async_result<> instance BEFORE waking up a suspended fiber
                            *value_ = std::move(t);
